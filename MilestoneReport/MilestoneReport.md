...
The used profanity words can be inspected [in this Github Repository](https://github.com/anitb/dscapstone/blob/master/profanityfilter.txt).
...
All used code snippets to generate this report can be viewed in this [repository](https://github.com/anitb/dscapstone/tree/master/MilestoneReport).
